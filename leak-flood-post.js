...
async function go() {
    // const textContent = fs.readFileSync("./txt-examp.txt", "utf8");
    const textContent = "a".repeat(1024 * 100);
                    ...
                    .connect(
                        ...
                        () => {
                            ...
                            async function main() {
                                ...
                                // body theo dạng x-www-form-urlencoded
                                const formBody = `action=set_dates&from=2025-09-30&to=2025-10-02&curlang=${textContent}`;
                                ...
                                const headers = Object.entries({
                                    ...
                                    // "cookie": "sucuricp_tfca_6e453141ae697f9f78b18427b4c54df1=1;"
                                });

                                // HEADERS frame
                                const headersBlock = hpack.encode(headers);
                                const headersFrame = encodeFrame(streamId, 1, headersBlock, 0x4); // END_HEADERS
                                ...
                                SocketTLS.write(headersFrame);
                                SocketTLS.write(dataFrame);
