                ...
                SocketTLS = tls
                    .connect(
                        ...
                        () => {
                            ...
                            let currentResponse = Buffer.alloc(0);
                                ...
                                while (data.length >= 9) {
                                    ...
                                    if (frame != null) {
                                        ...
                                        if (frame.type === 1) {
                                            ...
                                            currentHeaders = headers; // lưu lại header
                                            // console.log("==> HEADERS:", headers);

                                            const statusCodeHeader = headers.find((h) => h[0] === ":status");
                                            if (statusCodeHeader) {
                                        ...
                                        // DATA frame (nội dung HTML / JSON)
                                        if (frame.type === 0) {
                                            currentResponse = Buffer.concat([currentResponse, frame.payload]);
                                        }
                                        ...
                                        // END_STREAM (bit 0x1 trong flags) hoặc GOAWAY/RST_STREAM
                                        if ((frame.type === 0 && (frame.flags & 0x1)) || frame.type === 7 || frame.type === 5) {
                            ...
                            async function main() {
                                ...
                                function getCookieFromArr() {
                                    ...
                                    let lstCookies = JSON.parse(rawData);
                                ...
                                // let cookieOfProxy = await getCookieFromArr(selectedProxy, '');

                                async function checkProxy(proxy, c) {
                                ...
                                // let check = await checkProxy(selectedProxy, cookieOfProxy);
                                ...
                                const headers = Object.entries({
                                    ...
                                    ":scheme": "https",
                                    ":path": `/dasdasdsad/đasad`, // Thử root path trước
